...
try
{
  ...
  { 
    ...
    var icons = [
      ...
      {"name": "iPhone Notification iOS 7-11 20@2x",    "size":40},
      {"name": "iPhone Notification iOS 7-11 20@3x",    "size":60},      
      
      {"name": "iPhone Spotlight iOS Settings iOS 5-6 29",           	    "size":29}, 
      {"name": "iPhone Spotlight iOS Settings iOS 5-11 29@2x",           	"size":58}, 
      {"name": "iPhone Spotlight iOS Settings iOS 5-11 29@3x",           	"size":87}, 
      
      {"name": "iPhone Spotlight iOS 7-11 40@2x",           	"size":80}, 
      {"name": "iPhone Spotlight iOS 7-11 40@3x",           	"size":120}, 
      
      {"name": "iPhone App iOS 5-6 57",                 "size":57}, 
      {"name": "iPhone App iOS 5-6 57@2x",              "size":114}, 
      
      {"name": "iPhone App iOS 7-11 60@2x", "size":120},
      {"name": "iPhone App iOS 7-11 60@3x", "size":180},
      
      {"name": "App Store iOS 1024", "size":1024},      
      
      {"name": "iPad Notifications iOS 7-11 20",            "size":20},
      {"name": "iPad Notifications iOS 7-11 20@2x",         "size":40},     
      
      {"name": "iPad Settings iOS 5-11 29",           	"size":29}, 
      {"name": "iPad Settings iOS 5-11 29@2x",          "size":58}, 
      
      {"name": "iPad Spotlight iOS 7-11 40",           	"size":40}, 
      {"name": "iPad Spotlight iOS 7-11 40@2x",          "size":80},
      
      {"name": "iPad Spotlight iOS 5,6 50",           	"size":50}, 
      {"name": "iPad Spotlight iOS 5,6 50@2x",          "size":100},
      
      {"name": "iPad App iOS 5,6 72",               "size":72},
      {"name": "iPad App iOS 5,6 72@2x",           	"size":144},
      
      {"name": "iPad App iOS 7-11 76",             	"size":76},
      {"name": "iPad App iOS 7-11 76@2x",            "size":152},

      {"name": "iPad Pro App iOS 9-11 83.5pt@2x",           	"size":167}
